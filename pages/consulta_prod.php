<?php
    ...
    if(!empty($_GET['search'])){
        ...
        $sql = $conexao->prepare("SELECT * FROM `produtos` WHERE (id_produto LIKE '$search%' or nome LIKE '$search%') AND (status = ? OR '' = ?) ORDER BY id_produto ASC");

    } else {   
        $statusFilter = isset($_GET['status']) ? $_GET['status'] : '';
        $sql = $conexao->prepare("SELECT * FROM `produtos` WHERE status = ? OR '' = ? ORDER BY id_produto DESC");
    }
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="content">
        ...
        <h3 class="box-border">Consultar produtos</h3>
        ...
        <div class="box-border">
            <div class="box-search form-row">
                ...
                <div class="form-group ml-auto">
                    <!-- <label for="" >aaa</label> -->
                    <br>
                    <a href="../pages/cadastro_prod.php" class="btn btn-success">Cadastrar produto</a>
                </div>
            </div>
            ...
            <tbody>
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td> <?= $quantidade; ?> </td>
                        <td> <?= $status; ?> </td>
                        <td> <a href="detalhe_prod.php?id_produto=<?= $id_produto; ?>" class="btn btn-secondary btn-sm" >Detalhes</a></td>
                    </tr>
    ...
    <script>
        ...
        function searchData() {
            window.location = 'consulta_prod.php?search=' + search.value + '&status=' + statusDropdown.value;
        }
    </script>
