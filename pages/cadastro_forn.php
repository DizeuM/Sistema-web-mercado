...
<body>
    ...
    <div class="content">
        ...
        <h3 class="box-border">Cadastrar fornecedor</h3>

        <div class="box-border">
            
            <form action="../script/cadastrar_forn.php" method="post">
            ...
            <?php
                ...
                if(isset($_GET['sucess']) and $_GET['sucess'] == 2){
                    ...
                    <strong>Erro ao cadastrar o fornecedor.</strong>  Verifique se todos os campos estão preenchidos e tente novamente.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                    </div>';
